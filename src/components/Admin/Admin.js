...
import { GoogleSheetInfo } from "./constants/gg-info";
            ...
            <div className="container py-5">
                ...
                <div className="row justify-content-center">
                    <div className="col-md-10">
                        <h1 className="text-center mb-4 text-uppercase" style={{ color: '#F57E25', fontSize: '3rem' }}>Danh sách đăng ký học</h1>
                        <div className="table-responsive">
                            <table className="table table-bordered table-hover ">
                                <thead className="thead-light" style={{ fontSize: '1.5rem' }}>
                                    <tr >
                                        <th scope="col">Tên</th>
